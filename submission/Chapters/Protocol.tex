...
\section{Setup}
The setup procedure consists of several subprotocols that are responsible for setting up all the needed parameters for the private communication to take place.
